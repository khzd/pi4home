...
.. seo::
    :description: Instructions for setting up the Ethernet configuration for your ESP32 node in PI4Home.
    :image: ethernet.png
    :keywords: Ethernet, ESP32

This core PI4Home component sets up ethernet connections for ESP32s.
