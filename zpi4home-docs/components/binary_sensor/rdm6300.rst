...
.. seo::
    :description: Instructions for setting up RDM6300 NFC/RFID tag readers and tags in PI4Home.
    :image: rdm6300.jpg
...
with PI4Home. This component is a global hub that establishes the connection to the RDM6300 via :ref:`UART <uart>` and
