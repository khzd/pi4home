...
With PI4Home you can use different types of binary sensors. They will
...
With binary sensor filters you can customize how PI4Home handles your binary sensor values even more.
...
The triggers for binary sensors in PI4Home use the lingo from computer mouses.
