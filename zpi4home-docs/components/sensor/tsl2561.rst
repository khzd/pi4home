...
.. seo::
    :description: Instructions for setting up TSL2561 ambient light sensors in PI4Home.
    :image: tsl2561.jpg
    :keywords: TSL2561
...
`Adafruit`_)
ambient light sensor with PI4Home. The :ref:`I²C <i2c>` is required to be set up in
