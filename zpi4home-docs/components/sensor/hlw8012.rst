...
PI4Home. This sensor is commonly found in Sonoff POWs.
...
PI4Home will continuously cycle the state of the SEL pin to measure current *and* voltage, though both cannot
