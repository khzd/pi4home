...
.. seo::
    :description: Instructions for setting up real time clock sources in PI4Home like network based time.
    :image: clock-outline.png
    :keywords: NTP, SNTP, RTC

The ``time`` component allows you to set up real time clock time sources for PI4Home.
...
The preferred way to get time in PI4Home is using Home Assistant.
...
- **timezone** (*Optional*, string): Manually tell PI4Home what timezone to use with `this format
  ...
  <Region>/<City>. PI4Home tries to automatically infer the timezone string based on the timezone of the computer
  that is running PI4Home, but this might not always be accurate.
...
- **timezone** (*Optional*, string): Manually tell PI4Home what timezone to use with `this format
  ...
  PI4Home tries to automatically infer the timezone string based on the timezone of the computer that is running
  PI4Home, but this might not always be accurate.
