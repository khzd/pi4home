...
.. seo::
    :description: Instructions for setting up PCF8574 digital port expanders in PI4Home.
    :image: pcf8574.jpg
...
`Sparkfun`_) in PI4Home. It uses :ref:`I²C Bus <i2c>` for communication.

Once configured, you can use any of the 8 pins (PCF8574) or 16 pins (PCF8575) as
pins for your projects. Within PI4Home they emulate a real internal GPIO pin
and can therefore be used with many of PI4Home's components such as the GPIO
