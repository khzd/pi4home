...
.. seo::
    :description: Instructions for re-creating a BRUH multisensor using PI4Home.
    :image: bruh.png

The BRUH Multisensor is a great introductory project into Home Automation with an
amazing setup tutorial. And fortunately PI4Home has complete support for all the
