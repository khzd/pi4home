...
.. seo::
    :description: Instructions for setting up PIR (passive infrared) motion detection sensors in PI4Home
    :image: pir.jpg
    :keywords: PIR
...
PI4Home. These sensors measure the infrared light emitted from objects in its
...
To configure PI4Home for use with the PIR sensor, use a
