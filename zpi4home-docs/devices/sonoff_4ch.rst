...
.. seo::
    :description: Instructions for putting Sonoff 4CH devices into flash mode and installing PI4Home on them.
    :image: sonoff_4ch.jpg

PI4Home can also be used with Sonoff 4CH wireless switches. These devices are
...
This guide will step you through setting up your Sonoff 4CH and flashing the first PI4Home firmware
...
With this information, you can step through the PI4Home wizard (``pi4home sonoff_4ch.yaml wizard``),
...
Now run ``pi4home sonoff_4ch.yaml compile`` to validate the configuration and
...
Hooray 🎉! You've now successfully uploaded the first PI4Home firmware to your Sonoff 4CH. And in a moment,
you will be able to use all of PI4Home's great features with your Sonoff 4CH.
...
with automation example <https://github.com/khzd/pi4home/pi4home-docs/blob/current/devices/sonoff_4ch.yaml>`__.
