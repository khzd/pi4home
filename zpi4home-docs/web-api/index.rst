...
.. seo::
    :description: Migration guide for installing PI4Home on ESPs running ESPEasy.
    :image: espeasy.png

Since version 1.3, PI4Home includes a built-in web server that can be used to view states
...
or using the :doc:`Web Server Section </components/web_server>` in PI4Home.
...
While it's currently recommended to use PI4Home directly through Home Assistant, if you want
to integrate PI4Home with an external or self-built application you can use two available
