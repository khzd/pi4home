...
def libpr_role(name, rawtext, text, lineno, inliner, options=None,
               content=None):
    ref = 'https://github.com/khzd/pi4home/pi4home-core/pull/{}'.format(text)
    return [make_link_node(rawtext, 'core#{}'.format(text), ref, options)], []


def yamlpr_role(name, rawtext, text, lineno, inliner, options=None,
                content=None):
    ref = 'https://github.com/khzd/pi4home/pi4home/pull/{}'.format(text)
    return [make_link_node(rawtext, 'pi4home#{}'.format(text), ref, options)], []


def docspr_role(name, rawtext, text, lineno, inliner, options=None,
                content=None):
    ref = 'https://github.com/khzd/pi4home/pi4home-docs/pull/{}'.format(text)
...
def ghedit_role(name, rawtext, text, lineno, inliner, options=None,
    ...
    ref = 'https://github.com/khzd/pi4home/pi4home-docs/blob/current/{}'.format(path)
...
def setup(app):
    ...
    app.add_role('pi4homepr', yamlpr_role)
