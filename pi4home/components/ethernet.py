...
from pi4home.components import wifi
import pi4home.config_validation as cv
from pi4home.const import CONF_DOMAIN, CONF_ID, CONF_MANUAL_IP, CONF_STATIC_IP, CONF_TYPE, \
    CONF_USE_ADDRESS, ESP_PLATFORM_ESP32
from pi4home.core import CORE
from pi4home.cpp_generator import Pvariable, add
from pi4home.cpp_helpers import gpio_output_pin_expression
...
EthernetType = pi4home_ns.enum('EthernetType')
ETHERNET_TYPES = {
...
EthernetComponent = pi4home_ns.class_('EthernetComponent', Component)
