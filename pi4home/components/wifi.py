...
from pi4home.automation import CONDITION_REGISTRY, Condition
import pi4home.config_validation as cv
from pi4home.const import CONF_AP, CONF_BSSID, CONF_CHANNEL, CONF_DNS1, CONF_DNS2, CONF_DOMAIN, \
...
from pi4home.core import CORE, HexInt
from pi4home.cpp_generator import Pvariable, StructInitializer, add, variable
from pi4home.cpp_types import App, Component, pi4home_ns, global_ns

IPAddress = global_ns.class_('IPAddress')
ManualIP = pi4home_ns.struct('ManualIP')
WiFiComponent = pi4home_ns.class_('WiFiComponent', Component)
WiFiAP = pi4home_ns.struct('WiFiAP')

WiFiPowerSaveMode = pi4home_ns.enum('WiFiPowerSaveMode')
WIFI_POWER_SAVE_MODES = {
    'NONE': WiFiPowerSaveMode.WIFI_POWER_SAVE_NONE,
    'LIGHT': WiFiPowerSaveMode.WIFI_POWER_SAVE_LIGHT,
    'HIGH': WiFiPowerSaveMode.WIFI_POWER_SAVE_HIGH,
}
WiFiConnectedCondition = pi4home_ns.class_('WiFiConnectedCondition', Condition)
