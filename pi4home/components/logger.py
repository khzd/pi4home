...
from pi4home.automation import ACTION_REGISTRY, LambdaAction
...
LOG_LEVELS = {
    'NONE': global_ns.PI4HOME_LOG_LEVEL_NONE,
    'ERROR': global_ns.PI4HOME_LOG_LEVEL_ERROR,
    'WARN': global_ns.PI4HOME_LOG_LEVEL_WARN,
    'INFO': global_ns.PI4HOME_LOG_LEVEL_INFO,
    'DEBUG': global_ns.PI4HOME_LOG_LEVEL_DEBUG,
    'VERBOSE': global_ns.PI4HOME_LOG_LEVEL_VERBOSE,
    'VERY_VERBOSE': global_ns.PI4HOME_LOG_LEVEL_VERY_VERBOSE,
}
...
LogComponent = pi4home_ns.class_('LogComponent', Component)
...
def required_build_flags(config):
    flags = []
    if CONF_LEVEL in config:
        flags.append(u'-DPI4HOME_LOG_LEVEL={}'.format(str(LOG_LEVELS[config[CONF_LEVEL]])))
