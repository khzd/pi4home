...
from pi4home.components.remote_receiver import RemoteControlComponentBase, remote_ns
import pi4home.config_validation as cv
from pi4home.const import CONF_ADDRESS, CONF_CARRIER_DUTY_PERCENT, CONF_CHANNEL, CONF_CODE, \
