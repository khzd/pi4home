...
from pi4home.const import CONF_FREQUENCY, CONF_ID, CONF_NAME, CONF_PIN, CONF_SCL, CONF_SDA, \
    ESP_PLATFORM_ESP32
from pi4home.cpp_generator import Pvariable, add
from pi4home.cpp_types import App, Nameable, PollingComponent, pi4home_ns

ESP_PLATFORMS = [ESP_PLATFORM_ESP32]

ESP32Camera = pi4home_ns.class_('ESP32Camera', PollingComponent, Nameable)
ESP32CameraFrameSize = pi4home_ns.enum('ESP32CameraFrameSize')
FRAME_SIZES = {
