...
from pi4home.const import CONF_ID, CONF_MODE, CONF_NUMBER, CONF_PINS, CONF_RUN_CYCLES, \
    CONF_RUN_DURATION, CONF_SLEEP_DURATION, CONF_WAKEUP_PIN
from pi4home.cpp_generator import Pvariable, StructInitializer, add, get_variable
from pi4home.cpp_helpers import gpio_input_pin_expression, setup_component
from pi4home.cpp_types import Action, App, Component, pi4home_ns, global_ns
...
DeepSleepComponent = pi4home_ns.class_('DeepSleepComponent', Component)
EnterDeepSleepAction = pi4home_ns.class_('EnterDeepSleepAction', Action)
PreventDeepSleepAction = pi4home_ns.class_('PreventDeepSleepAction', Action)

WakeupPinMode = pi4home_ns.enum('WakeupPinMode')
WAKEUP_PIN_MODES = {
...
Ext1Wakeup = pi4home_ns.struct('Ext1Wakeup')
EXT1_WAKEUP_MODES = {
