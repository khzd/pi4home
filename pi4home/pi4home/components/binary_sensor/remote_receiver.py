...
from pi4home.components.remote_receiver import RemoteReceiverComponent, remote_ns
from pi4home.components.remote_transmitter import RC_SWITCH_RAW_SCHEMA, \
...
from pi4home.const import CONF_ADDRESS, CONF_CHANNEL, CONF_CODE, CONF_COMMAND, CONF_DATA, \
    ...
    CONF_STATE, CONF_RC5
from pi4home.cpp_generator import Pvariable, get_variable, progmem_array
from pi4home.cpp_types import int32
