...
from pi4home import automation, core
from pi4home.automation import CONDITION_REGISTRY, Condition, maybe_simple_id
from pi4home.components import mqtt
from pi4home.components.mqtt import setup_mqtt_component
import pi4home.config_validation as cv
from pi4home.const import CONF_DELAYED_OFF, CONF_DELAYED_ON, CONF_DEVICE_CLASS, CONF_FILTERS, \
...
BINARY_SENSOR_SCHEMA = cv.MQTT_COMPONENT_SCHEMA.extend({
    ...
    vol.Optional(CONF_INVERTED): cv.invalid(
        ...
        "https://github.com/khzd/pi4home/components/binary_sensor/index.html."
    ),
})
