...
from pi4home.const import CONF_ID, CONF_INITIAL_VALUE, CONF_RESTORE_VALUE, CONF_TYPE
from pi4home.cpp_generator import Pvariable, RawExpression, TemplateArguments, add
from pi4home.cpp_helpers import setup_component
from pi4home.cpp_types import App, Component, pi4home_ns

GlobalVariableComponent = pi4home_ns.class_('GlobalVariableComponent', Component)
