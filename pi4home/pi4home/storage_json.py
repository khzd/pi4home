...
from pi4home.helpers import mkdir_p

# pylint: disable=unused-import, wrong-import-order
from pi4home.core import CoreType  # noqa
...
def storage_path():  # type: () -> str
    return CORE.relative_path('.pi4home', '{}.json'.format(CORE.config_filename))


def ext_storage_path(base_path, config_filename):  # type: (str, str) -> str
    return os.path.join(base_path, '.pi4home', '{}.json'.format(config_filename))


def pi4home_storage_path(base_path):  # type: (str) -> str
    return os.path.join(base_path, '.pi4home', 'pi4home.json')


def trash_storage_path(base_path):  # type: (str) -> str
    return os.path.join(base_path, '.pi4home', 'trash')


# pylint: disable=too-many-instance-attributes
class StorageJSON(object):
    def __init__(self, storage_version, name, pi4home_core_version, pi4home_version,
        ...
        # The pi4home-core version in use
        assert pi4home_core_version is None or isinstance(pi4home_core_version, dict)
        self.pi4home_core_version = pi4home_core_version  # type: Dict[str, str]
        # The pi4home version this was compiled with
        self.pi4home_version = pi4home_version  # type: str
    ...
    def as_dict(self):
        return {
            ...
            'name': self.name,
            'pi4home_core_version': self.pi4home_core_version,
            'pi4home_version': self.pi4home_version,
    ...
    @staticmethod
    def from_pi4home_core(esph, old):  # type: (CoreType, Optional[StorageJSON]) -> StorageJSON
        return StorageJSON(
            storage_version=1,
            name=esph.name,
            pi4home_core_version=esph.pi4home_core_version,
            pi4home_version=const.__version__,
            src_version=1,
    ...
    def _load_impl(path):  # type: (str) -> Optional[StorageJSON]
        ...
        pi4home_core_version = storage.get('pi4home_core_version',
                                           storage.get('pi4homelib_version'))
        pi4home_version = storage.get('pi4home_version', storage.get('pi4homeyaml_version'))
        ...
        return StorageJSON(storage_version, name, pi4home_core_version, pi4home_version,
                           src_version, arduino_version, address, esp_platform, board, build_path,
                           firmware_bin_path, use_legacy_ota)
...
class EsphomeStorageJSON(object):
    def __init__(self, storage_version, cookie_secret, last_update_check,
        ...
        # The last time PI4Home checked for an update as an isoformat encoded str
