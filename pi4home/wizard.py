...
from pi4home.const import ESP_PLATFORMS, ESP_PLATFORM_ESP32, ESP_PLATFORM_ESP8266
from pi4home.helpers import color, get_bool_env
# pylint: disable=anomalous-backslash-in-string
from pi4home.pins import ESP32_BOARD_PINS, ESP8266_BOARD_PINS
from pi4home.py_compat import safe_input, text_type
from pi4home.storage_json import StorageJSON, ext_storage_path
...
if get_bool_env('PI4HOME_QUICKWIZARD'):
    def sleep(time):
        pass
else:
...
def wizard(path):
    ...
    safe_print("Hi there!")
    sleep(1.5)
    safe_print("I'm the wizard of PI4Home :)")
    sleep(1.25)
    safe_print("And I'm here to help you get started with PI4Home.")
    sleep(2.0)
    ...
    safe_print("Almost there! PI4Home can automatically upload custom firmwares over WiFi "
    ...
    safe_print("  > https://github.com/khzd/pi4home/guides/getting_started_command_line.html")
    return 0
