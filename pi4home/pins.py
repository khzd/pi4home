...
from pi4home.const import CONF_INVERTED, CONF_MODE, CONF_NUMBER, CONF_PCF8574, CONF_MCP23017
from pi4home.core import CORE
from pi4home.cpp_types import Component, pi4home_ns, io_ns
...
I2CDevice = pi4home_ns.class_('I2CDevice')
