...
void APDS9960::report_gesture_(int gesture) {
  APDS9960GestureDirectionBinarySensor *bin;
  switch (gesture) {
    case 1:
...
APDS9960ColorChannelSensor *APDS9960::make_red_channel(const std::string &name) {
  return this->red_channel_ = new APDS9960ColorChannelSensor(name, this);
}
APDS9960ColorChannelSensor *APDS9960::make_green_channel(const std::string &name) {
  return this->green_channel_ = new APDS9960ColorChannelSensor(name, this);
}
...
APDS9960GestureDirectionBinarySensor *APDS9960::make_up_direction(const std::string &name) {
  return this->up_direction_ = new APDS9960GestureDirectionBinarySensor(name);
}
APDS9960GestureDirectionBinarySensor *APDS9960::make_down_direction(const std::string &name) {
  return this->down_direction_ = new APDS9960GestureDirectionBinarySensor(name);
}
APDS9960GestureDirectionBinarySensor *APDS9960::make_left_direction(const std::string &name) {
  return this->left_direction_ = new APDS9960GestureDirectionBinarySensor(name);
}
