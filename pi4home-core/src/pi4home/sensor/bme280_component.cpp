...
float BME280Component::get_setup_priority() const { return setup_priority::HARDWARE_LATE; }
...
BME280TemperatureSensor *BME280Component::get_temperature_sensor() const { return this->temperature_sensor_; }
BME280PressureSensor *BME280Component::get_pressure_sensor() const { return this->pressure_sensor_; }
BME280HumiditySensor *BME280Component::get_humidity_sensor() const { return this->humidity_sensor_; }
