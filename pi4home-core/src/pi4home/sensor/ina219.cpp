...
static const char *TAG = "sensor.ina219";
...
INA219VoltageSensor *INA219Component::make_shunt_voltage_sensor(const std::string &name) {
  return this->shunt_voltage_sensor_ = new INA219VoltageSensor(name, this);
}
INA219CurrentSensor *INA219Component::make_current_sensor(const std::string &name) {
  return this->current_sensor_ = new INA219CurrentSensor(name, this);
}
INA219PowerSensor *INA219Component::make_power_sensor(const std::string &name) {
