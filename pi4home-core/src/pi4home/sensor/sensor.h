#ifndef PI4HOME_SENSOR_SENSOR_H
#define PI4HOME_SENSOR_SENSOR_H
...
class Sensor : public Nameable {
 public:
  ...
  union {
     ...
     *
     * This is exposed through a member variable for ease of use in pi4home lambdas.
     */
    float state;
