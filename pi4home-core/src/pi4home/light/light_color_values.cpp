...
LightColorValues LightColorValues::lerp(const LightColorValues &start, const LightColorValues &end, float completion) {
  LightColorValues v;
  v.set_state(pi4home::lerp(start.get_state(), end.get_state(), completion));
  v.set_brightness(pi4home::lerp(start.get_brightness(), end.get_brightness(), completion));
  v.set_red(pi4home::lerp(start.get_red(), end.get_red(), completion));
  v.set_green(pi4home::lerp(start.get_green(), end.get_green(), completion));
  v.set_blue(pi4home::lerp(start.get_blue(), end.get_blue(), completion));
  v.set_white(pi4home::lerp(start.get_white(), end.get_white(), completion));
  v.set_color_temperature(pi4home::lerp(start.get_color_temperature(), end.get_color_temperature(), completion));
