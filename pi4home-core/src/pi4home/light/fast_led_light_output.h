#ifndef PI4HOME_LIGHT_FAST_LED_LIGHT_OUTPUT_H
#define PI4HOME_LIGHT_FAST_LED_LIGHT_OUTPUT_H
 ...
 * as possible. To use FastLED lights with PI4Home, first set up the component using
...
#endif  // PI4HOME_LIGHT_FAST_LED_LIGHT_OUTPUT_H
