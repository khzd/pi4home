#ifndef PI4HOME_OUTPUT_GPIO_BINARY_OUTPUT_COMPONENT_H
#define PI4HOME_OUTPUT_GPIO_BINARY_OUTPUT_COMPONENT_H
...
#endif  // PI4HOME_OUTPUT_GPIO_BINARY_OUTPUT_COMPONENT_H
