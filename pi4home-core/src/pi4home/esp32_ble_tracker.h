#ifndef PI4HOME_ESP32_BLE_TRACKER_H
#define PI4HOME_ESP32_BLE_TRACKER_H
 ...
 * Neil Kolban. This was done because the ble library was quite huge and PI4Home would only
...
#endif  // PI4HOME_ESP32_BLE_TRACKER_H
