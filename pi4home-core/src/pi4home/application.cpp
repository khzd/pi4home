...
#ifdef USE_MQTT
using namespace pi4home::mqtt;
#endif
#ifdef USE_BINARY_SENSOR
using namespace pi4home::binary_sensor;
#endif
#ifdef USE_SENSOR
using namespace pi4home::sensor;
#endif
#ifdef USE_OUTPUT
using namespace pi4home::output;
#endif
#ifdef USE_LIGHT
using namespace pi4home::light;
#endif
#ifdef USE_FAN
using namespace pi4home::fan;
#endif
#ifdef USE_SWITCH
using namespace pi4home::switch_;
#endif
#ifdef USE_IO
using namespace pi4home::io;
#endif
#ifdef USE_COVER
using namespace pi4home::cover;
#endif
#ifdef USE_REMOTE
using namespace pi4home::remote;
#endif
#ifdef USE_TIME
using namespace pi4home::time;
#endif
#ifdef USE_TEXT_SENSOR
using namespace pi4home::text_sensor;
#endif
#ifdef USE_STEPPER
using namespace pi4home::stepper;
#endif
...
void Application::dump_config() {
  if (this->compilation_time_.empty()) {
    ESP_LOGI(TAG, "pi4home-core version " PI4HOME_VERSION);
  } else {
    ESP_LOGI(TAG, "pi4home-core version " PI4HOME_VERSION " compiled on %s", this->compilation_time_.c_str());
  }
