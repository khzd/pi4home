#ifndef PI4HOME_MQTT_MQTT_COMPONENT_H
#define PI4HOME_MQTT_MQTT_COMPONENT_H
 ...
 *
 * In order to best separate the front- and back-end of PI4Home, all sub-classes should
...
#endif  // PI4HOME_MQTT_MQTT_COMPONENT_H
