#ifndef PI4HOME_MQTT_MQTT_CLIENT_COMPONENT_H
#define PI4HOME_MQTT_MQTT_CLIENT_COMPONENT_H
...
class MQTTClientComponent : public Component {
 ...
 protected:
  ...
  int log_level_{PI4HOME_LOG_LEVEL};
...
#endif  // PI4HOME_MQTT_MQTT_CLIENT_COMPONENT_H
