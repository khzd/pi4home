#ifndef PI4HOME_BINARY_SENSOR_MQTT_BINARY_SENSOR_COMPONENT_H
#define PI4HOME_BINARY_SENSOR_MQTT_BINARY_SENSOR_COMPONENT_H
...
#endif  // PI4HOME_BINARY_SENSOR_MQTT_BINARY_SENSOR_COMPONENT_H
