...
.. seo::
    :description: Instructions for setting up lights and light effects in PI4Home.
    :image: folder-open.png

The ``light`` domain in PI4Home lets you create lights that will
...
PI4Home also offers a bunch of light effects you can use for your lights. The defaults for the
effect parameters are made to work well on their own but of course PI4Home gives you the option to manually change
these parameters.

With PI4Home's light effects system you're basically creating a bunch of entries for the effects dropdown in
...
https://github.com/khzd/pi4home/pi4home-core/blob/dev/src/pi4home/light/addressable_light_effect.cpp
