...
displays with PI4Home. Note that this component is for displays that are connected via the :ref:`I²C Bus <i2c>`.
...
and SH1106 (`datasheet <https://www.elecrow.com/download/SH1106%20datasheet.pdf>`__,
`electrodragon <https://www.electrodragon.com/product/1-3-12864-blue-oled-display-iicspi/>`__)
displays with PI4Home. Note that this component is for displays that are connected via the 4-Wire :ref:`SPI bus <spi>`.
