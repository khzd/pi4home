...
.. seo::
    :description: Instructions for setting up Xiaomi Mi Jia bluetooth-based temperature and humidity sensors in PI4Home.
...
To set up Xiaomi MiJia devices you first need to find their MAC Address so that PI4Home can
