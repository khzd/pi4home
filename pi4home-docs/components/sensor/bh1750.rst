...
.. seo::
    :description: Instructions for setting up BH1750 ambient light sensors in PI4Home.
    :image: bh1750.jpg
    :keywords: BH1750
...
ambient light sensor with PI4Home. The :ref:`I²C bus <i2c>` is required to be set up in
