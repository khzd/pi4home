...
.. seo::
    :description: Instructions for setting up BMP280 temperature and pressure sensors with PI4Home
    :image: bmp280.jpg
    :keywords: BMP280
...
`Adafruit`_) temperature and pressure sensors with PI4Home. The :ref:`I²C <i2c>` is
