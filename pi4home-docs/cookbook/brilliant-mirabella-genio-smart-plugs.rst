...
Originally intended to be used with their companion apps once flashed using `tuya-convert <https://github.com/ct-Open-Source/tuya-convert>`__ PI4Home generated
firmware can be uploaded allowing you to control the smart plugs via Home Assistant.

1. Create the PI4Home Firmware
------------------------------
...
#. Select a plug configuration below based on the plug/s you have and copy all of the text in the code block and paste into your
   ``name_of_pi4home_configuration.yaml`` file.
...
2.6 Upload PI4Home Firmware using SFTP
**************************************
...
2.7 Use tuya-convert to install PI4Home Firmware
************************************************
...
You can now add your smart plug to home assistant via the configurations page, look for 'PI4Home' under the Integrations option and click 'Configure'.
