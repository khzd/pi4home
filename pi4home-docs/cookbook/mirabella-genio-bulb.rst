...
Originally intended to be used with their companion app once flashed using `tuya-convert <https://github.com/ct-Open-Source/tuya-convert>`__ PI4Home generated
...
You can now add your bulb to home assistant via the configurations page, look for 'PI4Home' under the Integrations option and click 'Configure'.
