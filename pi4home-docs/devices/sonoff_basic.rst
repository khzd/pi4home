...
.. seo::
    :description: Instructions for putting Sonoff basic devices into flash mode and installing PI4Home on them.
    :image: sonoff_basic.jpg

PI4Home can be used with Sonoff Basic. These devices are basically just
...
With this information, you can also step through the PI4Home wizard (``pi4home sonoff_basic.yaml wizard``)
...
Now run ``pi4home sonoff_basic.yaml compile`` to validate the configuration and
...
.. code-block:: text
    ...
    INFO Reading configuration...
    INFO Detected timezone 'SAST' with UTC offset 2
    INFO Starting log output from fishpond.device using PI4Home API
    ...
    [11:13:27][I][application:097]: You're running PI4Home v1.10.1 compiled on Jan 16 2019, 08:12:59
...
- `Edit this page on GitHub <https://github.com/khzd/pi4homedocs/blob/current/pi4homeyaml/devices/sonoff_basic.rst>`__
