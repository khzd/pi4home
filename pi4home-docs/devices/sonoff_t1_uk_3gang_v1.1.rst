...
.. seo::
    :description: Instructions for putting Sonoff T1 UK 3 Gang devices into flash mode and installing PI4Home on them.
    :image: sonoff_t1_uk_3g_v1.1.jpg

PI4Home can also be used with Sonoff T1 UK 3 Gang wireless switches. These devices are
...
This guide will step you through setting up your Sonoff T1 UK 3 Gang and flashing the first PI4Home firmware
...
.. note::
    ...
    PI4Home can generate a firmware binary which you can then upload via the
...
flash the initial PI4Home firmware is by physically opening the device up and using the UART
interface.
...
- Computer running PI4Home or Hass.io add-on.
...
With this information, you can step through the PI4Home wizard (``pi4home sonoff_t1_uk_3g.yaml wizard``),
...
Now run ``pi4home sonoff_t1_uk_3g_v1.1.yaml compile`` to validate the configuration and
...
.. code-block:: bash
    ...
    pi4home sonoff_t1_uk_3g_v1.1.yaml run
...
Hooray 🎉! You've now successfully uploaded the first PI4Home firmware to your Sonoff T1 UK 3 Gang. And in a moment,
you will be able to use all of PI4Home's great features with your Sonoff T1 UK 3 Gang. Now you can put your T1 back together and fire up.
...
Above example also showcases an important concept of pi4home: IDs and linking. In order
to make all components in pi4home as much "plug and play" as possible, you can use IDs to define
...
with automation example <https://github.com/khzd/pi4homedocs/blob/current/devices/sonoff_t1_uk_3gang_v1.1.yaml>`__.
