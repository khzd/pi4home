...
.. seo::
    :description: Instructions for putting Sonoff S20 devices into flash mode and installing PI4Home on them.
    :image: sonoff_s20.jpg

PI4Home can also be used with Sonoff S20 smart sockets. These devices are
...
This guide will step you through setting up your Sonoff S20 and flashing the first PI4Home firmware
...
-  Computer running PI4Home Hass.io add-on.
...
With this information, you can step through the PI4Home wizard (``pi4home sonoff_s20.yaml wizard``),
...
Now run ``pi4home sonoff_s20.yaml compile`` to validate the configuration and
...
Hooray 🎉! You've now successfully uploaded the first PI4Home firmware to your Sonoff S20. And in a moment,
you will be able to use all of PI4Home's great features with your Sonoff S20.
...
with automation example <https://github.com/khzd/pi4homedocs/blob/current/devices/sonoff_s20.yaml>`__.
...
header pins again, as you will hopefully not need to use them again because of PI4Home's Over-The-Air
