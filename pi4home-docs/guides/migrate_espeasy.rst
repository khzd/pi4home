...
PI4Home create a binary for you and then upload that in the ESPEasy web interface.
...
the binary. If everything succeeds, you should now have PI4Home on your node 🎉.
